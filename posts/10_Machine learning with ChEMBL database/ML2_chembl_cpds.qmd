...
Pandas dataframe library was chosen this time, as Scikit-learn mainly supports Pandas dataframes for ML (so Polars not used here).
...
Check scikit-learn for cross validation method
