...
Since *Scikit-learn* mainly supports Pandas dataframes for ML, I've opted to use Pandas instead of Polars dataframe library.
...
2. Since we've used LogisticRegressionCV(), this meant it would be unnecessary to use GridSearchCV, as this was already taken into account.
