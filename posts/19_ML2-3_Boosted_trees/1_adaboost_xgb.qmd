...
![An example of code output from running above misclassification error code](accuracy_score_output.jpg)
...
![An example of code output from running the grid search code](gs_output.jpg)
