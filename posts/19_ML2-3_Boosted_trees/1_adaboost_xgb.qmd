...
*Update on 30th Jan 2025 - A new safe inference mode feature has been introduced in Scikit_mol recently which will be able to handle invalid SMILES, please visit this [demonstration notebook](https://github.com/EBjerrum/scikit-mol/blob/main/notebooks/11_safe_inference.ipynb) for details (thanks to Esben Jannik Bjerrum for mentioning this in the comment below).*
