...
For rpy2 package, I've tried it in a [separate post](https://jhylin.github.io/Data_in_life_blog/posts/22_Back_to_basics/1_Using_r_in_python_rpy2.html). Interestingly, I had to pause in the middle of working on it due to an issue about plotting. I've since returned to it after trying out reticulate, and have found a way to generate a plot using ggplot2 in rpy2.
...
Initial preparation - this notebook has been created using a virtual environment from uv, with the [associated repository](https://github.com/jhylin/Back_to_basics) created using the uv project management structure as well (please also see this [part](https://jhylin.github.io/Data_in_life_blog/posts/22_Back_to_basics/2_Using_python_in_r_reticulate.html#regarding-reproducibility-of-projects-in-r) regarding virtual environment in R). This step has been done prior to the executions of the following steps.
