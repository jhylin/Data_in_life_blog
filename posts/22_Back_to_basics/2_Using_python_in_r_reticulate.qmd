...
For rpy2 package, I've tried it in a separate post (**add link**). Interestingly, I had to pause in the middle of working on it due to an issue about plotting and started working on current post using reticulate. I've since returned to it after trying out reticulate, and have found a way to generate a plot using ggplot2 in rpy2.
...
##### **Plotting in R using ggplot2 and in Python using plotnine**
...
Then I'm using R's well-known plotting package, [ggplot2](https://ggplot2.tidyverse.org/), to plot a scatter plot based on a sample dataset using read_df.py as an example shown below.
