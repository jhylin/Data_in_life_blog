...
-   Link: [here](https://jhylin.shinyapps.io/molviz_app/) or please visit https://jhylin.shinyapps.io/molviz_app/, or alternatively at <https://huggingface.co/spaces/jhylin/Molviz_app>

-   Code: [here](https://github.com/jhylin/Molviz_app) or please visit https://github.com/jhylin/Molviz_app

**Update on 29/7/2026**: *I've come across the news update recently that Posit is slowly going to phase out several of its different platforms including shinyapps.io and start integrating them into one uniformed platform. I've gone back to visit my old HF account and realised that the app is actually running fine currently (!), except that sometimes the images of molecules may get over blown that'll cover some of the other surrounding texts underneath. So another link to this old app has been added at the top. Perhaps I should look at updating/upgrading the app in fact if time allows...*
...
This file was provided by Posit (formerly known as RStudio) from their Python for Shiny app template in HF as an example script for an app.
