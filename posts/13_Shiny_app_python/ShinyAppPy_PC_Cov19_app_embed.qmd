...
subtitle: Embedding app in a Quarto document for compounds in COVID-19 clinical trials
...
The entire code for this Shiny app in Python on this particular set of PubChem data were written in VS Code initially. When I was looking for places to deploy the app, I then migrated the code to RStudio IDE (details explained below).

For data preparation stage, please visit this post to see details.
...
Code for this .qmd document available here: *provide GitHub link*
