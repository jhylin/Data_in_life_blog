...
For Python project[^1], there was one question in mind to answer:

[^1]: The published date of this project would be based on the last day I've worked on associated file, prior to the blog move
...
For R project[^2], there were two questions in mind to answer:

[^2]: The R versions, base R and Tidyverse projects, were done after the Python one was completed
