...
This function was likely not novel and most likely other clever works in similar thread would have already been available. However, I thought to play around with it a bit and add on the ability to read multiple SMILES at the same time - somehow this was my first taste on writing a very simple function with a bit of cheminformatics purpose.
...
cpd3_mols
```
How I started then to think more on the tangent of writing a function, was that I found this "SmilesWriter" from RDKit from a few other blogs online. 
