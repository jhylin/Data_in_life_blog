...
Change column name of "Smiles" - to ensure the _preprocess function will work as smiles_column = "smiles" with lowercase "s" - will be using this function to cater for the 3 FtsZ compounds as well.
...
**Pre-processing and standardising molecules using datamol**
