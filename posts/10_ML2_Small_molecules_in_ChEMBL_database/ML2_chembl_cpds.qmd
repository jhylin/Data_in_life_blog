...
The overall idea of the ML series for small molecules in ChEMBL database could be visualised through the following flow chart (built through Mermaid). Currently, this post was targeting the ML series 2 area as shown below.

```{mermaid}
%%{ init: { 'flowchart': { 'curve': 'monotoneY' } } }%%
flowchart TB
  subgraph ML series 1
  A[Wrangled/cleaned dataset] --> B(Train data)
  A --> C(Test data)
  end
