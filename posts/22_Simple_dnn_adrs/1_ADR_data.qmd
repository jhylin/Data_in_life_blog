...
*note: "cyp_strength_of_evidence source" column has been renamed as "cyp_type_and_cyp_strength_of_evidence in the cyp_substrates_adrs.csv file"*

This is all based on the Flockhart table of drug interactions at [https://drug-interactions.medicine.iu.edu/MainTable.aspx](https://drug-interactions.medicine.iu.edu/MainTable.aspx)
...
*May turn each drug into sub-headings later for quick access from table of contents in blog post*
