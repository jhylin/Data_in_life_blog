...
All drug names and CYP strengths of evidence are based on the Flockhart cytochrome P450 drug-drug interaction table [@Flockhart2021], which is available at [https://drug-interactions.medicine.iu.edu/MainTable.aspx](https://drug-interactions.medicine.iu.edu/MainTable.aspx).
