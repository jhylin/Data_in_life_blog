...
There was only a slight increase in log loss score, although not really significant.
...
It was without any surprised that the re-trained model did not provide a huge difference from the initial model, which was already predicted in ML series 2. However, the purpose of tuning the parameters to reach a more optimied model was shown with a less than 1% increase in accuracy score and an even smaller increase in log loss value for the re-trained model. 
