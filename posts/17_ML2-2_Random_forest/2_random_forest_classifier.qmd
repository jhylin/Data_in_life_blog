...
Time for some plots if anyone's interested - I've shown two different ways to plot ROC curve below.

1.  Using *scikit-learn*

###### **Testing set ROC curve**

Obviously, this was not a good classifier with a poor AUC.
