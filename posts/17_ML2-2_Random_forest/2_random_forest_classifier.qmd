...
5.  Two approaches were used in the GHOST (generalized threshold shifting) paper:
    ...
    -   Approach 2 led to [GHOST](https://github.com/rinikerlab/GHOST) procedure to optimise and shift the decision threshold for any classification methods to catch the minor actives (rather than the major portion of inactives)
