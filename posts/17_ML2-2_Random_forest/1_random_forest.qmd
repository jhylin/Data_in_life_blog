...
When R^2^ was closer to 1, the better the model is. If it was negative, then likely model was not performing as well as expected or as quoted from scikit-learn "arbitrarily worse".
...
Shapley additive explanations was added here to provide a another way to figure out the feature importances. The GitHub repository for this SHAP approach could be accessed [here](https://github.com/shap/shap).
