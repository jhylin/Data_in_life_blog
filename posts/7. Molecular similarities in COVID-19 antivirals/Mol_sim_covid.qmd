...
The coding will start from here:
...
df_ms_new
```
All 3 molecular comparisons' T_coeff from rows 1 to 3 showed very similar results for T_coeff if we rounded the results to two decimal places. Also, this was probably not a very good example of using these two molecular similarity parameters in RDKit due to the small sample size.
