...
There were about 0.26% increase in accuracy score when using the LogR model with the tuned parameters from ML series 2, when compared with the LogR model made initially in ML series 1, which had an accuracy score of 0.6992084432717678.
